...
import { Check, Star, ArrowRight, Heart, Briefcase, Cake, Sparkles } from 'lucide-react';
    ...
    const services = [
        {
            ...
            image: marriageImg,
            description: 'Transformez votre mariage en un conte de fées inoubliable. Notre équipe s\'occupe de chaque détail pour créer la célébration de vos rêves.',
            features: [
            ...
            packages: [
                ...
                },
                {
                    name: 'Prestige',
                    price: 'Sur devis',
                    description: 'Service haut de gamme tout inclus avec options sur mesure'
                }
            ]
        },
        {
            ...
            image: corporateImg,
            description: 'Des événements corporate qui marquent les esprits. Séminaires, lancements de produits, galas d\'entreprise - nous gérons tout avec professionnalisme.',
            features: [
            ...
            packages: [
                {
                    ...
                    description: 'Événements d\'entreprise pour 50-100 personnes'
                },
                {
                    name: 'Corporate Plus',
        ...
        },
        {
            ...
            image: familyImg,
            description: 'Célébrez les moments précieux de la vie avec style. Anniversaires, baptêmes, fêtes familiales - chaque événement mérite d\'être spécial.',
            features: [
        ...
        },
        {
            ...
            image: decorImg,
            description: 'Créez l\'ambiance parfaite avec nos services de décoration sur mesure. De l\'élégance classique au moderne audacieux.',
            features: [
                ...
                <div className="container mx-auto px-4 relative z-10">
                    ...
                    >
                        ...
                        <p className="text-xl text-gray-200 mb-8">
                            Des prestations sur mesure pour faire de chaque événement un moment inoubliable
                        </p>
                        <Link to="/contact">
                                            ...
                                            <ul className="grid grid-cols-1 md:grid-cols-2 gap-3">
                                                {service.features.map((feature, idx) => (
                                                    <li key={idx} className="flex items-start gap-2">
                                                        <Check size={20} className="text-gold-600 flex-shrink-0 mt-1" />
                                            ...
                                            <div className="space-y-3">
                                                {service.packages.map((pkg, idx) => (
                                                    <div key={idx} className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                                                        <div>
                                                            <h4 className="font-semibold text-primary-950">{pkg.name}</h4>
                                                            <p className="text-sm text-gray-600">{pkg.description}</p>
                                                        </div>
                                                        <div className="text-right">
                                                            <p className="font-bold text-gold-600 whitespace-nowrap">{pkg.price}</p>
                                                        </div>
                                                    </div>
                                                ))}
                                            </div>
                ...
                <div className="container mx-auto px-4">
                    ...
                    >
                        ...
                        <p className="text-gray-300 text-lg max-w-2xl mx-auto">
                            Une expertise reconnue et un engagement sans faille pour votre satisfaction
                        </p>
                    </motion.div>
