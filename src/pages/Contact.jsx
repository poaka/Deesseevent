...
const Contact = () => {
    ...
    const contactInfo = [
        ...
        },
        {
            icon: <Mail size={24} />,
            title: 'Email',
            content: 'contact@deesseevent.com',
            link: 'mailto:contact@deesseevent.com'
        },
        {
            icon: <Clock size={24} />,
            title: 'Horaires',
                ...
                <div className="container mx-auto px-4 relative z-10">
                    ...
                    >
                        ...
                        <p className="text-xl text-gray-200">
                            Parlez-nous de votre projet et recevez un devis personnalisé gratuit
                        </p>
                    </motion.div>
                </div>
            </section>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                        {contactInfo.map((info, index) => (
                            ...
                            >
                                ...
                                {info.link ? (
                                    <a href={info.link} className="text-gray-600 hover:text-gold-600 transition-colors">
                                        {info.content}
                                    </a>
                                ) : (
                        ...
                        >
                            ...
                            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                                ...
                                <div>
                                    ...
                                    >
                                        <option value="">Sélectionnez...</option>
                                        <option value="< 1M">Moins de 1 000 000 FCFA</option>
                ...
                <div className="container mx-auto px-4">
                    ...
                    >
                        ...
                        <p className="text-gray-600">
                            Basés à Yaoundé, nous servons toute la région
                        </p>
                    </motion.div>
                        ...
                        <div className="aspect-video bg-gray-200 rounded-lg overflow-hidden shadow-lg">
                            <div className="w-full h-full flex items-center justify-center text-gray-500">
                                ...
                                <div className="text-center">
                                    ...
                                    <p className="text-lg">Carte à intégrer</p>
